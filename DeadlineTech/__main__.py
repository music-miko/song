...
import asyncio
import importlib
import uvloop  # ✅ ensure uvloop is imported early
...
async def init():
    ...
    LOGGER("DeadlineTech.plugins").info(
        "✅ All required modules imported. Starting DeadlineTech Bot initialization..."
    )
    ...
    LOGGER("DeadlineTech").info("DeadlineTech Music Bot started successfully and is now running.")
    await idle()
...
if __name__ == "__main__":
    ...
    try:
        ...
        pass  # fallback to default loop if uvloop not available
